  ...
  describe('GET /item/:id', () => {
    describe('when item exists', () => {
      it('should return the item', async () => {
        ...
        const response = await server.inject({ method: 'GET', url: `/item/${id}` });
        expect(response.statusCode).toBe(200);
    ...
    describe('when item does not exist', () => {
      it('should return 404', async () => {
        const response = await server.inject({ method: 'GET', url: '/item/999' });
  ...
  describe('DELETE /item/:id', () => {
    describe('when item exists', () => {
      it('should delete the item and return 204', async () => {
        ...
        const response = await server.inject({ method: 'DELETE', url: `/item/${id}` });
    ...
    describe('when item does not exist', () => {
      it('should return 404', async () => {
        const response = await server.inject({ method: 'DELETE', url: '/item/999' });
        expect(response.statusCode).toBe(404);
      });
    });
  });
